...
import { getOverview, findVisibleProduct } from "@/lib/overview";
...
export default async function ProductPage({ params }: { params: Promise<{ company: string; product: string }> }) {
  ...
  return <OverviewDashboard overview={overview} companyName={found.company.name} productName={found.name} />;
}
