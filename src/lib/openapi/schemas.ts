  ...
  schemas: {
    ...
    CalendarFeed: {
      ...
      properties: {
        ...
        environment: { type: "string", nullable: true, description: "An environment slug, or `group:<slug>` for a whole environment group" },
        types: { type: "array", items: { type: "string" } },
        mergeLots: { type: "boolean", description: "One event per lot instead of one per member service" },
        createdAt: { type: "string", format: "date-time" },
      },
    },
    AuditRow: {
